...
const DsButton = class {
    ...
    render() {
        return (index.h(index.Host, { key: '872802d87a63c8523578b3711f33d1f31abac163' }, index.h("button", { key: '1bbb2f83c11cd8e3e4f7c1a2776d58350702faff', class: `btn btn--${this.variant} btn--${this.size}`, disabled: this.disabled, type: this.type }, index.h("slot", { key: '0fcaab2e382eb49c712d4846c8ba844f398ab6ad' }))));
    }
};
DsButton.style = dsButtonCss;

exports.ds_button = DsButton;
//# sourceMappingURL=ds-button.entry.cjs.js.map
